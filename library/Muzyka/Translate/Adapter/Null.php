...
class Muzyka_Translate_Adapter_Null extends Zend_Translate_Adapter
{
  protected $_automatic = true;

  protected $_extToParser = array(
    'php' => 'Muzyka_Translate_Parser_Array',
    'csv' => 'Muzyka_Translate_Parser_Csv',
    'mo'  => 'Muzyka_Translate_Parser_Gettext', // Double check extension
    'ini' => 'Muzyka_Translate_Parser_Ini'
  );
