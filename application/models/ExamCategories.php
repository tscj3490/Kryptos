...
class Application_Model_ExamCategories extends Muzyka_DataModel
{
    protected $_name = "exam_categories";
    protected $_base_name = 'ec';
    protected $_base_order = 'ec.id ASC';
