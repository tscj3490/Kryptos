...
class Muzyka_Helper_FlashMessenger extends Zend_View_Helper_Abstract
{
    /**
     * @var Zend_Controller_Action_Helper_FlashMessenger
     */
    private $_flashMessenger = null;
    public $template ='<div class="alert alert-%s">
							<div>%s</div>
						</div>';
    /**
     ...
     */
    public function flashMessenger($key = 'attention',$template='')
    {
        ...
        foreach ($messages as $message)
        {
            ...
            $output .= sprintf($this->template,$key,$message);
        }
